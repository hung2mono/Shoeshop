    ...
    <body>
        ...
        <div class="cen">
            ...
            <tr>
                ...
                <th style="border: 1px solid #ddd;padding: 8px; background-color: #4CAF50; color: white;">Giá trị mã giảm giá </th>
                <th style="border: 1px solid #ddd;padding: 8px; background-color: #4CAF50; color: white;">Giờ</th>
            ...
            <tr>
                ...
                <td style="border: 1px solid #ddd;padding: 8px;">${bill.discount}</td>
                <td style="border: 1px solid #ddd;padding: 8px;">${time}</td>
                <td style="border: 1px solid #ddd;padding: 8px;">${date}</td>
                <td>
                    <a href="DetailBill.jsp?id=${id}"><button style="background-color: white; border: solid 1px #ccc; border-radius: 5px;>Xem Chi tiết</button></a>
                </td>
            </tr>
            <%
                }
