  ...
  <body>
      ...
      <div class="fashion">
        <div class="package">
          <div class="fashion1">
            <div class="thumbai">
              <span class="icon-sale" style="padding-top:10px;padding-right:8px; font-weight:bold;">-55%</span>
              <a href="DetailProduct.jsp?id=53" id="clother-out" ><img src="css/fs1.jpg" alt="" style="width:280px; height:400px;"></a>
              <a href="DetailProduct.jsp?id=53" id="clother-in"><img src="css/fs11.jpg" alt="" style="width:280px; height:400px"></a>
              <a href="DetailProduct.jsp?id=53" class="name" title="Jean rách ống bó - Blue White">Jean rách ống bó - Blue White</a>
              <ul>
                <li style="color: red; margin-left:20px">580.000₫</li>
                <li style="color: #a6a6a6;text-decoration: line-through;">1.299.000₫</li>
              </ul>
            </div>
          </div>
          <div class="fashion1">
            <div class="thumbai">
              <span class="icon-sale" style="padding-top:10px;padding-right:8px; font-weight:bold;">-55%</span>
              <a href="DetailProduct.jsp?id=53" id="clother-out" ><img src="css/fs2.jpg" alt="" style="width:280px; height:400px"></a>
              <a href="DetailProduct.jsp?id=53" id="clother-in"><img src="css/fs22.jpg" alt="" style="width:280px; height:400px"></a>
              <a href="DetailProduct.jsp?id=53" class="name" title="Jean rách ống bó - Black">Jean rách ống bó - Black</a>
              <ul>
                <li style="color: red; margin-left:20px">580.000₫</li>
                <li style="color: #a6a6a6;text-decoration: line-through;">1.299.000₫</li>
              </ul>
          ...
          <div class="fashion1">
            <div class="thumbai">
              <span class="icon-sale" style="padding-top:10px;padding-right:8px; font-weight:bold;">-55%</span>
              <a href="DetailProduct.jsp?id=53" id="clother-out" ><img src="css/fs3.jpg" alt="" style="width:280px; height:400px"></a>
              <a href="DetailProduct.jsp?id=53" id="clother-in"><img src="css/fs33.jpg" alt="" style="width:280px; height:400px"></a>
              <a href="DetailProduct.jsp?id=53" class="name" title="Jean rách ống bó - Blue" >Jean rách ống bó - Blue</a>
              <ul>
                <li style="color: red; margin-left:20px">580.000₫</li>
                <li style="color: #a6a6a6;text-decoration: line-through;">1.299.000₫</li>
              </ul>
